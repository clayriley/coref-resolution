...
train_dir=`find "$SOURCE/train" -type f -regex '.+\.v[0-9]_auto_conll'`
test_dir=`find "$SOURCE/test" -type f -regex '.+\.v[0-9]_gold_conll'`
dev_dir=`find "$SOURCE/dev" -type f -regex '.+\.v[0-9]_auto_conll'`
